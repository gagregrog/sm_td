...
#define SM_MT(tap_key, ...) SMTD_MT(SM_##tap_key, tap_key, __VA_ARGS__)
#define SMTD_MTE(...) SMTD_GET_MACRO(__VA_ARGS__, SMTD_MTE5, SMTD_MTE4, SMTD_MTE3)(__VA_ARGS__)
#define SM_MTE(tap_key, ...) SMTD_MTE(SM_##tap_key, tap_key, __VA_ARGS__)
#define SMTD_LT(...) SMTD_GET_MACRO(__VA_ARGS__, SMTD_LT5, SMTD_LT4, SMTD_LT3)(__VA_ARGS__)
#define SM_LT(tap_key, ...) SMTD_LT(SM_##tap_key, tap_key, __VA_ARGS__)
